...
Функция ПодготовитьТекстВМ()
	...
	//Сообщить("ПодготовитьТекстВМ() НАЧАЛО");
	...
	|	СообщитьВОтладке(""Класс.СуперТаймер ВыполнитьПроцедуруГлМодуля()"");
